...
\int & \dfrac{\d x}{(x^2 \pm a^2)^{\frac{3}{2}}} = \pm\dfrac{x}{a^2\sqrt{x^2 \pm a^2}} + C 
\end{align*}
\section{三角函数积分}
\subsection{配凑法}
\begin{example}
...
\begin{solution}
    \begin{align*}
        ...
        &=\dfrac{1}{2} \int \dfrac{\d (2\tan x)}{3 + (2\tan x)^2} = \boxed{\dfrac{1}{2\sqrt{3}} \arctan \dfrac{2\tan x}{\sqrt{3}} + C}
    \end{align*}
\end{solution}
\begin{myRemark}
    三角函数积分常用替换方法：
...
\begin{solution}
    \begin{align*}
        ...
        = \boxed{\ln |\tan x|-\dfrac{1}{2\tan^2 x} + C}
    \end{align*}
\end{solution}
\begin{example}
...
\begin{solution}
    \begin{align*}
        ...
        =\boxed{\dfrac{1}{3}\sec^3 x - \sec x + C}
    \end{align*}
\end{solution}
\begin{example}
...
\begin{solution}
    \begin{align*}
        ...
        &=\boxed{\dfrac{1}{3}\tan^3 x-\tan x+x +C}
    \end{align*}
\end{solution}
\begin{example}
...
\begin{solution}
    ...
    移项化简得
    \[
        \boxed{\int \dfrac{1}{\sin^3 x} \d x = \dfrac{1}{2} \left( \ln |\csc x - \cot x| -\csc x\cot x \right) + C}
    \]
\end{solution}
...
\begin{solution}
    ...
    =\boxed{\dfrac{1}{\sqrt{2}} \ln \left| \csc (x + \frac{\pi}{4}) - \cot (x + \frac{\pi}{4}) \right| + C}$
\end{solution}
\begin{myRemark}
...
\subsection{万能代换}
\begin{theorem}
    设$f(\sin x, \cos x)$在区间$I$上连续，且$\cos \dfrac{x}{2} \neq 0$，则在$I$上有
    \[
...
\begin{solution}
    \begin{align*}
        ...
        =\int \dfrac{\d u}{1+u}
        =\ln |1+u|+C\\[6pt]
        &=\boxed{\ln \left|\tan \dfrac{x}{2}+1\right|+C}
    \end{align*}
\end{solution}
\begin{example}
...
\begin{solution}
    \begin{align*}
        ...
        =\boxed{\dfrac{\pi}{\sqrt{2}} - \dfrac{1}{\sqrt{2}} \arctan (\sqrt{2})}
    \end{align*}
\end{solution}
\begin{myRemark}
...
\begin{solution}
    ...
    \begin{align*}
        ...
        = 8\pi a \cdot \dfrac{1}{2}\pi a^2 = \boxed{4\pi^2 a^3}
    \end{align*}
    法二（柱壳法）：
    ...
    \begin{align*}
        ...
        = 4\pi a^3 \left( 2 \cdot \frac{\pi}{2} + 0 \right) = \boxed{4\pi^2 a^3}
    \end{align*}
\end{solution}
\subsection{旋转体的表面积}
\begin{theorem}
...
\begin{solution}
    ...
    \begin{align*}
        ...
        = 12\pi a^2 \cdot \dfrac{1}{5} \sin^5 t \Bigg|_{0}^{\frac{\pi}{2}} = \boxed{\dfrac{12}{5}\pi a^2}
    \end{align*}
\end{solution}
...
\begin{solution}
    \begin{align*}
        ...
        \xlongequal{t=2x} \int_{0}^{+\infty} \dfrac{\sin t}{t} \d t = \boxed{\dfrac{\pi}{2}}
    \end{align*}
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    故由夹逼定理可得
    \[
        \lim_{n \to \infty} \left( \dfrac{\sin \frac{\pi}{n}}{n+1} + \dfrac{\sin \frac{2\pi}{n}}{n+\frac{1}{2}} + \cdots + \dfrac{\sin \frac{n\pi}{n}}{n+\frac{1}{n}} \right) = \boxed{\dfrac{2}{\pi}}
    \]
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    综上所述，
    \[
        \boxed{\int_{0}^{\pi} \dfrac{\d x}{1 + a\cos x} =
        \begin{cases}
...
\begin{solution}
    \begin{align*}
        ...
        =\boxed{4\left( \ln\dfrac{\sqrt{2}+1}{2} - \sqrt{2} + 1 \right)}
    \end{align*}
\end{solution}
\begin{exercise}
...
\begin{solution}
    \begin{align*}
        ...
        =\dfrac{1}{2} \cdot \dfrac{3\pi}{8} = \boxed{\dfrac{3\pi}{16}}
    \end{align*}
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    \end{align*}
    故周长$L = \boxed{\sqrt{2} + \dfrac{\sqrt{5}}{2} + \dfrac{1}{4}\ln(\sqrt{5}+2)}$．

    (2).~ 计算$D_1$绕$y$轴旋转一周的体积$V$：
    \begin{align*}
        V &= 2\pi \int_{0}^{1} x [(2x-x^2) - x] \d x
        = 2\pi \int_{0}^{1} (x^2 - x^3) \d x \\
        = 2\pi \left( \frac{1}{3} - \frac{1}{4} \right) = \boxed{\frac{\pi}{6}}
    \end{align*}
\end{solution}
\ifx\allfiles\undefined
\end{document}
