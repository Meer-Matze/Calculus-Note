...
\begin{solution}
    \begin{align*}
        ...
        &=3f'(1) \cdot \dfrac{1}{2}= \dfrac{3}{2}f'(1)
    \end{align*}
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    故有斜渐进线$y=x-2$\\[6pt]
    当$x \to 1$时，$y=\dfrac{x^3}{x^2 +2x-3} \sim \dfrac{1}{x-1}$，故有垂直渐进线$x=1$\\[6pt]
    当$x \to -3$时，$y=\dfrac{x^3}{x^2 +2x-3} \sim -\dfrac{9}{2(x+3)}$，故有垂直渐进线$x=-3$
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    则$a=\dfrac{1}{2}\left(a + \dfrac{1}{a}\right) \Rightarrow a=1$，故$\lim\limits_{n \to \infty} x_n = 1$.
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    \begin{align*}
        ...
        =2 \times \left(-\dfrac{1}{6}\right) + 2 \times \dfrac{1}{6} = 0
    \end{align*}
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    \]
    由于$f(x)$在$x=0$附近有界，令$n \to \infty$，得$f(x)=\dfrac{8}{7}x^2$
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    \begin{align*}
        ...
        =\lim\limits_{x \to +\infty} \displaystyle\sum_{k=1}^{n} \dfrac{a_k k}{\sqrt{k+x}+\sqrt{x}}=0
    \end{align*}
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    \end{align*}
    由夹逼定理可得$\lim\limits_{n \to \infty} \ln x_n = \dfrac{1}{2}$，即$\lim\limits_{n \to \infty} x_n = e^{\frac{1}{2}}$
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    \]
    故由夹逼定理可得
    \[\lim\limits_{x \to +\infty} \sqrt{x}\displaystyle\int_{x}^{x+1} \dfrac{1}{\sqrt{t+\sin t +x}} \d t = \dfrac{1}{\sqrt{2}}\]
\end{solution}
\begin{myRemark}
...
\begin{solution}
    ...
    故$f(2)<0$，由介值定理知$f(x)$在$(1,2)$内有零点，故选B．
\end{solution}
\begin{exercise}
...
\begin{solution}
    ...
    \end{align*}
    故$F(x)$在$[a,b]$上单调递增，且$F(a)=0$，故$F(b) > 0$，即$I_1 > I_2$，选A．
\end{solution}
\ifx\allfiles\undefined
\end{document}
\fi